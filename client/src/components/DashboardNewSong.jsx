      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 w-full'>
        <div className='flex flex-col items-center justify-center gap-4'>
          <input
            ...
            className='w-full p-3 rounded-md text-base font-semibold text-gray-200 outline-none shadow-sm border border-gray-300 bg-transparent'
            value={songName}
    ...
    <div className='flex items-center justify-evenly w-full flex-wrap'>
      ...
      <div className='flex flex-col items-center justify-center gap-4 '>
        <input
          ...
          className='w-full lg:w-300 p-3 rounded-md text-base font-semibold text-gray-100 outline-none shadow-sm border border-gray-100 bg-transparent'
          value={artistName}
        ...
        <div className='w-full lg:w-300 p-3 flex items-center rounded-md  shadow-sm border border-gray-300'>
          ...
          <input
            type='text'
            placeholder='your id'
            className='w-full text-base font-semibold text-gray-100 outline-none bg-transparent'
            value={twitter}
    ...
    <div className='flex items-center justify-evenly w-full flex-wrap'>
      ...
      <div className='flex flex-col items-center justify-center gap-4 '>
        <input
          ...
          className='w-full lg:w-300 p-3 rounded-md text-base font-semibold text-gray-100 outline-none shadow-sm border border-gray-300 bg-transparent'
          value={artistName}
          onChange={e => setArtistName(e.target.value)}
        />
